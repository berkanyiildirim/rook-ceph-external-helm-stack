...
export ROOK_EXTERNAL_FSID=x
export ROOK_EXTERNAL_USERNAME=client.healthchecker
export ROOK_EXTERNAL_CEPH_MON_DATA=a=x.x.x.x:6789
export ROOK_EXTERNAL_USER_SECRET=x
export ROOK_EXTERNAL_DASHBOARD_LINK=http://x.x.x.x:7000/
export CSI_RBD_NODE_SECRET=x
export CSI_RBD_NODE_SECRET_NAME=csi-rbd-node
export CSI_RBD_PROVISIONER_SECRET=x
export CSI_RBD_PROVISIONER_SECRET_NAME=csi-rbd-provisioner
#export RBD_POOL_NAME=didak1-pool
export CEPHFS_POOL_NAME=didak-fs-data0
export CEPHFS_METADATA_POOL_NAME=didak-fs-metadata
export CEPHFS_FS_NAME=didak-fs
export CSI_CEPHFS_NODE_SECRET=x
export CSI_CEPHFS_PROVISIONER_SECRET=x
...
CEPHFS_STORAGE_CLASS_NAME=ceph-fs
ROOK_EXTERNAL_MONITOR_SECRET=mon-secret
OPERATOR_NAMESPACE=rook-ceph-external                              # default set to rook-ceph
